...
import { WhatsAppButton } from "./WhatsAppButton";
 ...
 export default function Footer() {
  return (
 <section className="bg-[#23205a] text-white py-12">
  <WhatsAppButton phoneNumber={"945333000"}/>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "10px", marginTop: "20px" }}>
               <a
                    ...
                    className="w-10 h-10 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition-colors duration-200 transform hover:scale-110"
                    aria-label="LinkedIn"
                  >
                    <svg
        ...
        <div className="max-w-7xl mx-auto px-4 mt-8 pt-8 border-t border-gray-300">
